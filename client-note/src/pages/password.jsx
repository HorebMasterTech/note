...
import { passwordSend } from '../redux/actions/authAction';
...
const Password = () => {
    ...
    const handleSubmit = e => {
        e.preventDefault();
        dispatch(passwordSend(userData));
    }
  ...
  return (
    ...
    <div className='formulaire container max-w-lg absolute bg-neutral-800 p-8 rounded-xl shadow' style={{ left: '50%', top: "50%", transform: 'translate(-50%, -50%)' }} data-aos="fade-down-right">
       <div className='my-2 text-left px-10'>
            <h1 className='text-3xl font-medium tracking-widest'><i className="fa-solid fa-lock"></i> Mot de passe oublié</h1>
        </div>
        <form className='mx-10' onSubmit={handleSubmit}>
            <div className="flex flex-col">
                ...
                <button type='submit' className='w-full py-3 font-semibold text-white bg-black hover:bg-slate-900 rounded-lg border-slate-900 hover:shadow tracking-widest'>Envoyer</button>
            </div>
        </form>
